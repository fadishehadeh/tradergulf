...
<div class="page-hero-banner">
    <div class="container">
        <div class="banner-wrap">
            <img src="<?= url('assets/img/banners/sub-currency-converter.svg') ?>" alt="Currency Converter" width="800" height="200" loading="lazy" decoding="async">
            <a href="<?= url('currency-converter') ?>" class="banner-btn-link" aria-label="Open Currency Converter"></a>
        </div>
    </div>
</div>
...
<div class="container" style="padding:.75rem 0 0">
    <a href="<?= url('advertise') ?>" class="advertise-here-slot" data-track="cta_click" data-track-label="advertise_converter_top">
        <div class="adv-inner">
            <div><div class="adv-tag">Advertise With Us</div><div class="adv-title">Reach Traders Checking Exchange Rates</div><div class="adv-sub">Gulf traders converting AED, SAR, KWD &amp; USD daily. High-frequency, high-intent audience.</div></div>
